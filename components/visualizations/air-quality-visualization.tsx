    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            PM10 and PM2.5 concentrations in µg/m³
          </CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Nitrogen Dioxide and Ozone concentrations in µg/m³
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="h-[300px]">
            <ResponsiveContainer width="100%" height="100%">
              <LineChart data={airQualityData}>
                ...
                <Tooltip
                  ...
                  formatter={(value, name) => [
                    `${value} µg/m³`,
                    name === "nitrogen_dioxide" ? "NO₂" : "O₃",
                  ]}
                />
                <Legend />
                <Line
                  type="monotone"
                  dataKey="nitrogen_dioxide"
                  stroke="#ff7300"
                  name="NO₂"
                />
                <Line
          ...
          <div className="space-y-4 text-sm">
            <div>
              ...
              <p className="text-muted-foreground">
                Particulate matter with diameter less than 10 micrometers. Can
                penetrate the lungs and cause respiratory issues.
              </p>
            </div>
            <div>
              ...
              <p className="text-muted-foreground">
                ...
                Can enter the bloodstream and cause cardiovascular issues.
              </p>
            </div>
            <div>
              <h4 className="font-medium">NO₂ (Nitrogen Dioxide)</h4>
              <p className="text-muted-foreground">
                A gaseous air pollutant produced by combustion processes. Can
            ...
            <div>
              ...
              <p className="text-muted-foreground">
                A gas that can be good or bad depending on where it&apos;s
                found. Ground-level ozone can trigger health problems.
              </p>
            </div>
          </div>
        </CardContent>
